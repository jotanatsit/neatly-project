      ...
      <Flex direction="column" w="1440px">
         ...
         <Flex w="1440px" height={900} bg="url(/HomePage/bg-homepage.svg)" bgSize="cover" flexDirection="column">
            <Flex alignItems="center" justifyContent="center" >
               <Box  lineHeight="110px" letterSpacing="-2%" textAlign="center" mt={200}>
                  <Text textStyle="h1" color="white">A Best Place for Your <br />Neatly Experience</Text>
               </Box>
            </Flex>
            <Spacer />
            <Booking_box />
         ...
         <Flex w="1440px" height={1178} flexDirection="column" id='content' alignItems="center">
            <Flex height="50%" alignItems="center" justifyContent="center" flexDirection="column">
               <Box mr={750}>
                  <Text textStyle="h2" textAlign="left" color="green.800">Neatly Hotel</Text>
               </Box>
               <Box ml={120}>
                  ...
                  <Text textStyle="b2" textAlign="left" mt={8} color="gray.700">All units at the hotel are equipped with a seating area, a flat-screen TV with satellite channels, a dining area and a private <br /> bathroom with free toiletries, a bathtub and a hairdryer. Every room in Neatly Hotel features a furnished balcony. Some rooms <br /> are equipped with a coffee machine.</Text>
                  <Text textStyle="b2" textAlign="left" mt={8} color="gray.700"> Free WiFi and entertainment facilities are available at property and also rentals are provided to explore the area.</Text>
               </Box>
            </Flex>
         ...
         <Flex w="1440px" height={480} direction="column" alignItems="center" justifyContent="center" bg="green.700" id='service'>
            <Flex direction="column" alignItems="center" justifyContent="center">
               <Text textStyle="h1" color="white" textAlign="center" mb={6}>Service & Facilities</Text>
            </Flex>
